        ...
        <div>
            <div>
                <div className="stats bg-primary text-primary-content">
                    ...
                    <div className="stat">
                        <div className="stat-title w-300">Account balance</div>
            ...
            <div className="stats shadow">
                ...
                <div className="stat">
                    <div className="stat-figure text-secondary">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" sstrokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                    </div>
